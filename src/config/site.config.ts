...
Outside of code, I write technical articles, contribute to open-source when I can, and keep learning whatever tool or system looks like it'll help me do better work. Not big on fluff. Just here to build useful stuff and keep improving.`
  ...
  external: {
    ...
    featuredVideoUrl: "https://www.youtube.com/embed/MOkPoKh0-hA?si=DSxFyJUbzf3PMt9g",
  ...
  pages: {
    ...
    blog: {
      title: "Blog",
      description: "Sharing ideas, insights, and lessons learned from navigating the tech world."
    },
    publications: {
      title: "Publications",
  ...
  sections: {
    talks: {
      ...
      description: "Sharing knowledge and insights with the community through talks, workshops, and presentations"
    },
    featuredTalk: {
      title: "Featured Talk",
      subtitle: "Deep dive into modern development practices and cloud architecture"
    },
    collabnixMeetup: {
      title: "Collabnix Meetup",
      subtitle: "Community Event",
      description: "Engaged with the developer community to share insights on scalable systems, cloud architecture, and modern development practices."
    },
    recentPosts: {
  ...
  messages: {
    auth: {
      ...
      magicLinkSent: "🎉 Magic link sent! Check your email inbox and click the link to sign in.",
      magicLinkDescription: "Enter your email to receive a magic link for instant sign-in"
    },
    errors: {
